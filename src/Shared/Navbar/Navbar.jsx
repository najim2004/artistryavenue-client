...
const Navbar = () => {
  ...
  const menu = (
    <>
      ...
      <li>
        <NavLink to={"/all_art_&_craft_items"}>All Art & craft Items</NavLink>
      </li>
      <li>
        <NavLink to={"/add_craft_item"}>Add Craft Item</NavLink>
      </li>
      <li>
  ...
  // }, []);
  return (
    <div className="max-w-[1300px] flex pt-8 justify-between items-center h-full mx-auto">
      <div className="">
        <Link
          to={"/"}
