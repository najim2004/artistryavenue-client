...
import { MdOutlineSupportAgent, MdOutlineWorkspacePremium } from "react-icons/md";

const WhyChoseUs = () => {
  return (
    <div className="flex px-3 lg:px-0 max-w-[1300px] mx-auto flex-col items-center">
      ...
      <p className="mt-6 mb-12 max-w-[650px] text-center">
        ...
        exceptional quality, user-friendly experience, and outstanding customer
        service. Elevate your creativity with us today!
      </p>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="p-[30px] flex flex-col items-center rounded-2xl border-[5px] border-gray-100 justify-center text-center bg-[#fae8d3]">
          ...
          <p>
            Explore a wide range of paintings, from traditional to contemporary
            styles, ensuring there's something for every taste and preference
          </p>
        </div>
